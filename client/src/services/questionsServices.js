...
const addBounty = async (question_id, data) =>
    callQuestionsAPI('patch', `/${question_id}/addBounty`, data);
...
const closeQuestion = async (question_id, data) =>
    callQuestionsAPI('patch', `/${question_id}/close`, data);

const openQuestion = async (question_id, data) =>
    callQuestionsAPI('patch', `/${question_id}/reopen`, data);

const protectQuestion = async (question_id, data) =>
    callQuestionsAPI('patch', `/${question_id}/protect`, data);

const getQuestionVote = async (question_id) => callQuestionsAPI('get', `/${question_id}/vote`);
...
const updateCommentVote = async (question_id, comment_id, data) =>
    callQuestionsAPI('patch', `/${question_id}/comments/${comment_id}/vote`, data);
...
const updateAcceptAnswer = async (question_id, answer_id) =>
    callQuestionsAPI('patch', `/${question_id}/answers/${answer_id}/accept`);
...
const updateAnswerVote = async (question_id, answer_id, data) =>
    callQuestionsAPI('patch', `/${question_id}/answers/${answer_id}/vote`, data);
...
const postAnswerComment = async (question_id, answer_id, data) =>
    callQuestionsAPI('post', `/${question_id}/answers/${answer_id}/comments`, data);

const deleteAnswerComment = async (question_id, answer_id, comment_id) =>
    callQuestionsAPI('delete', `/${question_id}/answers/${answer_id}/comments/${comment_id}`);

const getAnswerCommentVote = async (question_id, answer_id, comment_id) =>
    callQuestionsAPI('get', `/${question_id}/answers/${answer_id}/comments/${comment_id}/vote`);
